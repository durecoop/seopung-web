...
export const PARTNERS: Partner[] = [
  { name: '푸드머스', logoPath: '/images/partners/foodmerce.png' },
  { name: '풀무원', logoPath: '/images/partners/pulmuone.png' },
  { name: '쿠팡', logoPath: '/images/partners/coupang.png' },
  { name: '두레생협', logoPath: '/images/partners/dure.png' },
  { name: 'CJ프레시웨이', logoPath: '/images/partners/cj.png' },
  { name: '웰스토리', logoPath: '/images/partners/welstory.png' },
];
