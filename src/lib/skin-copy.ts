...
export const SKIN_COPY: Record<number, SkinCopy> = {
  ...
  // 6: CJ 기업형 — 정직, 신뢰, 깔끔한 기업 톤 (CJ씨푸드 참고)
  6: {
    certLabel: 'Quality Certifications',
    certTitle: '안전과 품질,',
    certTitleAccent: '6대 인증으로 약속합니다',
    certDesc: '엄선된 원료와 철저한 공정 관리를 바탕으로',
    certDescBold: '최고의 품질과 안전한 제품만을 생산합니다',
    certCta: '인증 현황 자세히 보기',

    aboutLabel: 'About Seopung',
    aboutTitle1: '건강한 수산 가공식품',
    aboutTitle2: '전문기업',
    aboutDesc1: '1995년부터 전라남도 여수에서 수산 가공에 전념해온 서풍은 정직한 원료 선별과 위생적인 생산 환경을 최우선으로 합니다.',
    aboutDesc2: '고객의 식탁에 안전하고 맛있는 먹거리를 전합니다.',
    aboutDesc2Bold: '엄선된 어종, 철저한 위생관리, 변함없는 품질.',
    aboutCta: '회사소개 더 보기',

    prodLabel: 'Products',
    prodTitle: '정직함을 담아 만든',
    prodTitleAccent: '134+ 제품',
    prodDesc: '냉동수산가공부터 프리미엄 굴비, 밀키트까지\n엄격한 품질 관리를 거친 제품을 공급합니다',
    prodCta: 'MORE',

    supplyLabel: 'Process',
    supplyTitle: '생생한 공정을',
    supplyTitleAccent: '직접 확인하세요',
    supplyDesc: '원료 입고부터 포장·출하까지, 모든 공정을 투명하게 관리합니다',

    bannerTitle1: '최고의 품질과',
    bannerTitle2: '안전한 제품만을 약속합니다',
    bannerDesc: '엄선된 어종과 철저한 위생관리,\n변함없는 품질로 보답하겠습니다.',
    bannerCta: '공정 자세히 보기',

    partnerLabel: 'Partners',
    partnerTitle: '신뢰로 함께하는',
    partnerTitleAccent: '유통 파트너',
    partnerDesc: '전국 주요 유통 채널과의 안정적인 공급 네트워크',

    ctaTitle1: '서풍에',
    ctaTitle2: '문의하기',
    ctaDesc: 'OEM 납품, 신제품 개발, 파트너십 등\n무엇이든 편하게 문의해주세요.',
    ctaCta: '문의하기',
  },
};
