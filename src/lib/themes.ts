...
export const THEMES: Record<number, SiteTheme> = {
  ...
  // 6: 클린 시원 — 밝은 그라데이션, shop과 통일된 톤
  6: {
    id: 6, name: '클린 시원',
    navBg: 'bg-white/95 backdrop-blur-md shadow-sm',
    navText: 'text-gray-800', navHeroText: 'text-white/90', navAccent: 'text-ocean-500',
    certBg: 'bg-gradient-to-br from-ocean-600 via-ocean-500 to-ocean-700',
    certText: 'text-white',
    certCardBg: 'bg-white/10', certCardBorder: 'border-white/25',
    sectionBg1: 'bg-gradient-to-br from-warm-50 via-white to-ocean-50',
    sectionBg2: 'bg-gradient-to-tr from-ocean-50 via-white to-gold-50',
    bannerOverlay: 'from-ocean-600/85 via-ocean-600/55 to-ocean-600/30',
    ctaBg: 'bg-gradient-to-br from-ocean-500 via-ocean-600 to-ocean-700',
    ctaText: 'text-white',
    footerBg: 'bg-[#1c2d3f]', footerText: 'text-white', footerMuted: 'text-white/75',
    accent: 'bg-ocean-500', accentHover: 'hover:bg-ocean-600',
  },
};
