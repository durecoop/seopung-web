...
export default function TeamSection() {
  ...
  return (
    <section id="team" className="relative bg-gray-50 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <div className="relative aspect-[21/9] w-full md:aspect-[21/8]">
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 md:p-10">
              <p className="mb-2 font-montserrat text-sm font-medium uppercase tracking-widest text-ocean-500/80">
                Our Team
              </p>
              <h3 className="text-xl font-bold leading-snug text-gray-900 md:text-3xl">
                수산 가공의 전 과정을
                <br />
                책임지는 전문가들
              </h3>
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <svg
              className="mb-4 h-10 w-10 text-ocean-500/30"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
              <path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5 3.871 3.871 0 01-2.748-1.179zm10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5 3.871 3.871 0 01-2.748-1.179z" />
            </svg>
            <blockquote className="mb-6 text-xl leading-relaxed text-gray-700 md:text-2xl lg:text-3xl">
              매출 성장을 현장과 품질에 환원하는
              <br />
              <span className="text-ocean-500">선순환 재투자 경영</span>을 실천합니다
            </blockquote>
            <div className="flex items-center gap-3">
              <div className="h-px w-8 bg-ocean-500/40" />
              <div>
                <p className="text-base font-semibold text-gray-900">김태환 상무</p>
                <p className="text-sm text-gray-600">경영총괄</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {GALLERY.map((img, i) => (
            ...
            >
              <div className="relative aspect-[4/3] w-full">
                ...
                <p className="absolute bottom-4 left-4 text-sm font-medium text-gray-700">
                  {img.caption}
                </p>
              </div>
            </div>
