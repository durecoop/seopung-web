    ...
    <main className="bg-navy-950 font-pretendard">
          ...
          <FadeIn>
            <div className="text-center">
              ...
              <p className="text-xl leading-relaxed text-white/80 md:text-2xl md:leading-relaxed">
                ...
                <span className="text-white font-semibold">B2B OEM 수산 가공 전문 기업</span>입니다.
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <FadeIn>
            <div className="mb-16 text-center">
              ...
              <h2 className="text-3xl font-bold text-white md:text-4xl">제품 카테고리</h2>
            </div>
          </FadeIn>
              ...
              <FadeIn key={cat.id} delay={i * 120}>
                <div className="group relative overflow-hidden rounded-2xl border border-navy-700/50 bg-navy-900/60 backdrop-blur-sm transition-all duration-500 hover:border-gold-500/30 hover:bg-navy-800/60">
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <p className="mb-5 leading-relaxed text-white/60">{cat.desc}</p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {cat.items.map((item) => (
                        <span
                          key={item}
                          className="rounded-full border border-navy-600/60 bg-navy-800/40 px-3 py-1 text-xs font-medium text-white/70 transition-colors duration-300 group-hover:border-gold-500/30 group-hover:text-gold-400/80"
                        >
                          {item}
                        </span>
                      ))}
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <FadeIn>
            <div className="mb-16 text-center">
              ...
              <h2 className="text-3xl font-bold text-white md:text-4xl">어종 취급 현황</h2>
              ...
              {FISH_SPECIES.map((fish, i) => (
                <FadeIn key={fish.name} delay={i * 60}>
                  <div className="group flex flex-col items-center gap-3 rounded-2xl border border-navy-700/50 bg-navy-900/60 px-3 py-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-gold-500/30 hover:bg-navy-800/60">
                    {/* Fish icon */}
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gold-500/10 text-gold-400 transition-colors duration-300 group-hover:bg-gold-500/20">
                    ...
                    <div>
                      <p className="text-sm font-bold text-white">{fish.name}</p>
                      <p className="mt-0.5 text-[10px] font-medium text-white/40">{fish.en}</p>
                    </div>
                  </div>
                </FadeIn>
              ))}
        ...
        <div className="relative mx-auto max-w-5xl px-6 lg:px-8">
          <FadeIn>
            <div className="mb-16 text-center">
              ...
              <h2 className="text-3xl font-bold text-white md:text-4xl">OEM 역량</h2>
              <p className="mx-auto mt-4 max-w-xl text-base text-white/60">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {OEM_STATS.map((stat, i) => (
              <FadeIn key={stat.label} delay={i * 120}>
                <div className="group rounded-2xl border border-navy-700/50 bg-navy-900/60 px-6 py-10 text-center backdrop-blur-sm transition-all duration-500 hover:border-gold-500/30 hover:bg-navy-800/60">
                  ...
                  <span className="mt-2 block text-sm text-white/50">{stat.desc}</span>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
          <FadeIn>
            <p className="mb-4 font-montserrat text-sm font-semibold uppercase tracking-[0.25em] text-gold-400">
              Partnership
            </p>
