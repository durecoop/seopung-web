        ...
        <>
          ...
          <section className="relative h-[40vh] min-h-[320px] flex items-end">
            ...
            <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-12">
              ...
              <h1 className={`text-4xl font-bold ${c.text} md:text-5xl lg:text-6xl`}>기술·설비</h1>
              <p className={`mt-3 text-lg ${c.text2}`}>AI 기술이 지키는 품질, 스마트 팩토리</p>
            </div>
          </section>
            ...
            <div className="mx-auto max-w-7xl px-6">
              ...
              <FadeIn className="mt-12">
                <div className={`overflow-hidden rounded-2xl border ${c.cardBorder} ${c.sectionAlt} p-6 md:p-10`}>
                  <h3 className={`mb-6 text-center text-lg font-semibold ${c.text2}`}>AI 엑스레이 구성도</h3>
