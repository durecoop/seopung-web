...
const COPY: Record<number, TechCopy> = {
  ...
  6: {
    heroLabel: 'Technology & Facility',
    heroTitle: '기술·설비',
    heroSub: '최고의 품질과 안전을 위한 스마트 설비',
    xrayLabel: 'Quality Inspection',
    xrayTitle: 'AI 엑스레이',
    xrayAccent: '검출 시스템',
    xrayDesc: '농심엔지니어링과 약 6개월간 협업하여 도입한 AI 엑스레이는 X-ray 촬영 후 인공지능이 이물, 결함, 충진량 이상을 자동 판별하는 품질 검사 시스템입니다.',
    xrayDiagramTitle: 'AI 엑스레이 시스템 구성도',
    hyperLabel: 'Advanced Detection',
    hyperTitle: 'AI 초분광 검출기 —',
    hyperAccent: '차세대 품질 혁신',
    equipLabel: 'Equipment',
    equipTitle: '주요 설비',
    ...
    autoTitle: '체계적인',
    autoAccent: '생산 자동화',
    autoDesc: '안전하고 위생적인 생산을 위해 단계적으로 자동화 설비를 도입하고 있습니다.',
    roadmapLabel: 'Investment Plan',
    roadmapTitle: '투자',
    roadmapAccent: '계획',
    investLabel: '2026 Investment',
    investTitle: '2026년 투자 계획',
    qualityLabel: 'Quality Management',
    qualityTitle: '품질 관리',
    qualityAccent: '시스템',
    qualityClosing: '방사능 검사, 이물 관리, HACCP 기반 위생 관리를 통해 안전한 식품 생산을 최우선으로 합니다.',
  },
};
