...
const CERTIFICATIONS: CertificationItem[] = [
  ...
  },
  {
    ...
    name: '수산물이력제',
    year: '2013년',
    desc: '수산물이력추적시스템 — 생산부터 유통까지 투명하게 관리하는 수산물 이력 추적 시스템입니다. 서풍은 전품목에 이력추적관리를 적용하고 있습니다.',
    photo: null,
    logo: '/images/certs/traceability.png',
    badge: null,
    status: 'acquired',
  },
  {
    ...
    name: 'ASC 인증',
    year: '2024년',
    desc: '책임 있는 양식 수산물 생산을 위한 글로벌 지속가능 수산 인증입니다. 전 세계 소비자와 유통사가 신뢰하는 지속가능 양식 표준입니다.',
    photo: null,
    logo: '/images/certs/asc.png',
    badge: null,
    status: 'acquired',
  },
  {
    ...
    name: 'MSC 인증',
    year: '2024년',
    desc: '지속가능한 어업과 해양 자원 보호를 위한 관리 인증입니다. "지속가능한 어업"의 글로벌 기준으로 인정받고 있습니다.',
    photo: null,
    logo: '/images/certs/msc.png',
    badge: null,
    status: 'acquired',
  },
  {
