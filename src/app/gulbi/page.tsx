...
const GULBI_COPY: Record<number, GulbiCopy> = {
  ...
  6: {
    heroTitle: '영광 굴비',
    heroSub: '전통 방식으로 만드는 프리미엄 굴비',
    introText:
      '영어조합법인 서풍의 영광 굴비는 여수 위판장에서 직접 수매한 생물 참조기를 전통 방식으로 정성껏 제조합니다. 냉동 원료가 아닌 생물만을 사용하여 깊은 풍미를 자랑합니다.',
    whyLabel: 'Why Seopung Gulbi',
    whyHeading: '서풍 영광 굴비의 차별점',
    featureCard1Desc:
      '새벽 위판장에서 직접 수매한 참조기를 당일 영광으로 운송합니다. 냉동이 아닌 생물 원료만을 사용합니다.',
    featureCard2Desc:
      '기계 염장이 아닌 전통 아가미 섭간 방식으로 소금을 채워 깊고 자연스러운 풍미를 만듭니다.',
    featureCard3Desc:
      '숙련된 장인이 한 마리 한 마리 정성껏 수작업으로 엮습니다. 기계로는 대체할 수 없는 품질입니다.',
    closingQuote: '정직한 원료와 전통 방식으로 만든 영광 굴비를 전합니다',
    closingCta: '문의하기',
  },
};
